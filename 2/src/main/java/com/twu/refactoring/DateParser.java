...
public class DateParser {
    ...
    public Date parse() {
        ...
        year = parseYear(dateAndTimeString);
        month = parseMonth(dateAndTimeString);
        date = parseDate(dateAndTimeString);
        hour = parseTime(dateAndTimeString)[0];
        minute = parseTime(dateAndTimeString)[1];
    ...
    public int parseYear(String dateAndTimeString){
        int year;
        try {
    ...
    public int[] parseTime(String dateAndTimeString){
        int hour;
        int minute;
        if (dateAndTimeString.substring(11, 12).equals("Z")) {
            ...
            hour = parseHour(dateAndTimeString);
            minute = parseMinute(dateAndTimeString);
        }
